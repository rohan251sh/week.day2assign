...
public class LeafGround 
{
	...
	public static void main(String[] args)
	{
		...
		driver.findElement(By.name("j_idt88:name")).sendKeys("Rohan");
		...
		driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("imrohan2509@gmail.com");
		driver.findElement(By.id("j_idt88:j_idt101")).click();
		driver.findElement(By.id("j_idt88:j_idt101")).sendKeys("Rohan from Bangalore");
		driver.findElement(By.id("j_idt106:thisform:age")).click();
		driver.findElement(By.id("j_idt106:float-input")).click();
		driver.findElement(By.id("j_idt106:float-input")).sendKeys("rohan");
		driver.findElement(By.id("j_idt106:auto-complete_input")).click();
		driver.findElement(By.id("j_idt106:auto-complete_input")).sendKeys("Rohan");
		
		//WebElement third=driver.findElement(By.xpath("//li[@data-item-label='Rohan1']"));
		//Select option=new Select(third);
		//option.selectByVisibleText("Rohan1");
